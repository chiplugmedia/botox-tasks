...
import { Circle, Clock, TestTube, TrendingUp, Loader2 } from "lucide-react";
...
const Layout = ({ onLogout, user }) => {
  ...
  const StatCount = ({ title, value, icon }) => (
    <div className="p-2 sm:p-3 rounded-xl bg-white shadow-sm border border-purple-100 hover:shadow-md transition-all duration-300 hover:border-purple-100 group">
      <div className="flex items-center gap-2">
        <div className="p-1.5 rounded-lg bg-gradient-to-br from-function-500/20 to-purple-500/10 group-hover:from-fuchsia-500/20 group-hover:to-purple-500/20">
          {icon}
        </div>
        <div className="min-w-0">
          <p className="text-lg sm:text-xl font-bold bg-gradient-to-r from-blue-500 to-blue-600 bg-clip-text text-transparent">
            {value}
          </p>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="ml-0 xl:ml-64 pt-16 p-3 sm:p-4 transition-all duration-300">
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6">
          <div className="xl:col-span-2 space-y-3 sm:space-y-4">
            <Outlet
              context={{ tasks, loading, error, refreshTasks: fetchTasks }}
            />
          </div>
            ...
            <div className="bg-white rounded-xl p-4 sm:p-5 shadow-sm border border-purple-100">
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-6">
                <StatCount
                  ...
                  icon={<Circle className="w-3.5 h-3.5 sm:h-4 text-blue-500" />}
                />
                <StatCount
                  title="Completed"
                  value={stats.completedTasks}
                  icon={
                    <Circle className="w-3.5 h-3.5 sm:h-4 text-green-500" />
                  }
                />
                <StatCount
                  title="Pending"
                  ...
                  icon={
                    <Circle className="w-3.5 h-3.5 sm:h-4 text-yellow-500" />
                  }
                />
                <StatCount
              ...
              <div className="space-y-2 sm:space-y-3">
                <div className="flex items-center justify-between text-gray-700">
                  <span className="text-xs sm:text-sm font-medium flex items-center gap-1.5">
                    <Circle className="w-2.5 h-2.5 sm:h-3 text-purple-100 fill-blue-500" />
                    Task Progress
                  </span>
                  <span className="text-xs bg-purple-100 text-blue-700 px-1.5 py-0.5 sm:px-2 rounded-full">
                ...
                <div className="relative pt-1">
                  <div className="flex gap-1.5 items-center">
                    <div className="flex-1 h-2 sm:h-3 bg-purple-100 rounded-full overflow-hidden">
                      <div
                        className="h-full bg-gradient-to-r from-fuchsia-500 to-blue-600 transition-all duration-500"
